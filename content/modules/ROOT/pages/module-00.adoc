...
NOTE: This step can be skipped unless you wish to use your own Model as a Service Credentials. We will share the provided credentials to save time.
...
----
+
TIP: If the secrets file was encrypted we could unencrypt is as follows (the instructor will provide the key)
+
[source,bash,options="wrap",role="execute"]
----
