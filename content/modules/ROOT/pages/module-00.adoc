...
After a few minutes, you should see the following output to show that the apps have been installed.

image::bootstrap-complete.png[bootstrap-complete, 400]

Next, you will need to wait for the individual apps to be installed. This may take a few minutes.
