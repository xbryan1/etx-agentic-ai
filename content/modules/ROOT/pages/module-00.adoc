...
The Data Science team have also requested to use GPUs in their Data Science Workbenches e.g. when they use a Pytorch, CUDA or other stack image that can directly access an accelerator.
