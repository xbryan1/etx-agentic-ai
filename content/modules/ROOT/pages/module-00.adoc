...
. **Both team members: Clone the forked repository (in your web terminal if using the Web Terminal Operator as described above in the Quick Starts, locally otherwise)**
+
[source,bash,options="wrap",role="execute"]
----
git clone https://github.com/{your-gh-user}/etx-agentic-ai
cd etx-agentic-ai
----
+
.GitHub Repo Clone
