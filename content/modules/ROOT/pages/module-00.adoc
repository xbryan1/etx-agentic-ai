...
. We can see in this case that we have a https://aws.amazon.com/ec2/instance-types/g6e[**g6e.2xlarge**,window=_blank] instance. We can then check how many GPUs we are able to allocate:
+
[source,bash,options="wrap",role="execute"]
----
