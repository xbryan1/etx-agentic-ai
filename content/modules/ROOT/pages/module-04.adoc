...
[source,bash,options="wrap",role="execute"]
----
List the braches from ${YOUR_GITHUB_USER}/etx-agentic-ai repo.
----
+
image::llama-playground-mcp-github-chat.png[LlamaStack MCP GitHub, 800]
+
You can see the response in the pod logs for the mcp::github server in the agent-demo namespace.
