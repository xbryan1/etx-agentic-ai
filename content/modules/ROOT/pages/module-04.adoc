...
[source,bash,options="wrap",role="execute"]
----
Get the README.adoc from the ocp-eformat/etx-agentic-ai repo. give me the resource:text that contains the file contents. format the response as asciidoc and not json. remove any json keys and formatting.
----
+
