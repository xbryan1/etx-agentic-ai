...
====
Use the Playground for our actual Use Case prompting (requires pipeline failure pods)

. query namespace pod for a pod error; copy-paste search for solution to error logs
. create issue, add issue comments
