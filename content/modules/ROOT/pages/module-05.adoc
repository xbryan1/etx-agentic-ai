...
[TIP]
====
Why this matters (DORA and MTTR)
...
* In this module you’ll codify your agent so it can consistently triage failures and create an actionable GitHub issue. In xref:module-06.adoc[Module 06], we’ll wire this into the pipeline’s finally step so failures automatically trigger the agent—helping drive down MTTR.
====
